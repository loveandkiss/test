...
export function cleanCurrentVehicle ({ commit }, params) {
    return commit("cleanCurrentVehicleByState", params);
}
...
export function queryVehicleNoAudited ({ commit }, params) {
    return Vue.http.post(URL.VEHICLE_QUERYNOAUDITED,params)
        .then((response) => commit("queryVehicleSuccess", response.body))
        .catch(function (error) {console.log(error);});
}

export function queryVehicleIsAudited ({ commit }, params) {
    return Vue.http.post(URL.VEHICLE_QUERYISAUDITED,params)
        .then((response) => commit("queryVehicleSuccess", response.body))
        .catch(function (error) {console.log(error);});
}
