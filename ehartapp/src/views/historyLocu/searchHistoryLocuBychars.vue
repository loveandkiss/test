...
<script>
    ...
    import {parseTime, angle,toUpperStr} from '../../../assets/js/util'
    ...
    export default {
        ...
        methods: {
            goBack(){
                ...
                let [startTime,endTime,activeName,page,type] = [query.startTime,query.endTime,query.activeName,query.page,query.type];

                this.$router.push({
                    path: `/applyStatistics/applyStatisticsOfEchars${toUpperStr(type)}`,
                    query: {startTime,endTime,activeName,page,type}
                });
            },
            // 对地图添加线的方法
            mapPolyline(res){
