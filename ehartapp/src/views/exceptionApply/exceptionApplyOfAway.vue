        ...
        <div class = "tabclick">
            ...
            <el-dialog title="编辑行程单" :visible.sync="dialogFormVisibleEdit">
                <el-form :model="ruleFormEdit"  ref="ruleFormEdit" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="起点" prop="endPlace">
                        <el-input disabled type="text" v-model="ruleFormEdit1.name" auto-complete="off" placeholder="请输入终点"></el-input>
                    </el-form-item>

                    <el-form-item label="终点：" prop="startPlace" v-show="false">
                        <el-input type="text" v-model="ruleFormEdit.endPlace" auto-complete="off" placeholder="请输入起点"></el-input>
                    </el-form-item>

                    <el-form-item label="终点">
                        <el-select v-model="ruleFormEdit1.aaa" placeholder="请选择终点" @change="querySearch">
                            <el-option
...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            successEdit () {
                let _this = this;
                this.queryApplyExceptionOfAway({}).then(() => {
                    let page = _this.currentPage;
                    this.queryApplyExceptionOfAway({
                        page: page
                    }).then(() => {
                        this.$message({
                            type: 'success',
            ...
            handleEdit(index, row) {
                ...
                this.ruleFormEdit1 = row.startPlaceInfo;
            },
