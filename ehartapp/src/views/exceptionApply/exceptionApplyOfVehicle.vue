                ...
                <el-table
                    ...
                    >
                        <template scope="scope">
                            ...
                            <span style="margin-left: 10px"
                                  v-else>{{scope.row.endTime | parseTime('{y}-{m}-{d} {h}:{i}:{s}')}}</span>
                        </template>
                    </el-table-column>
        ...
        <el-dialog title="编辑行程单" :visible.sync="dialogFormVisibleEdit">
            <el-form :model="ruleFormEdit"  ref="ruleFormEdit" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="终点" prop="endPlace">
                    <el-input disabled type="text" v-model="ruleFormEdit2.name" auto-complete="off" placeholder="请输入起点"></el-input>
                </el-form-item>
...
<script>
    ...
    export default{
        ...
        methods: {
            ...
            successEdit () {
                let _this = this;
                this.queryApplyExceptionOfVehicle({}).then(() => {
                    let page = _this.currentPage;
                    this.queryApplyExceptionOfVehicle({
                        page: page
                    }).then(() => {
                        this.$message({
                            type: 'success',
            ...
            handleEdit(index, row) {
                ...
                this.ruleFormEdit2 = row.endPlaceInfo;
            },
            searchCarInfo(){
