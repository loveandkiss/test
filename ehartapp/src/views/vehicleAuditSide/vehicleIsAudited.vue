<template>
    <div class="el-col el-col-24 el-col-xs-24 el-col-sm-22 tabclick" style="height:100%">
        ...
        <el-dialog title="查看车辆信息" :visible.sync="dialogFormVisibleEdit">
            <el-form :model="ruleFormEdit" :rules="rulesEdit" ref="ruleFormEdit" label-width="100px"
                ...
                <el-form-item label="车队名称" prop="motorcadeName">
                    <el-input type="text" v-model="ruleFormEdit.motorcadeName" auto-complete="on"
                              placeholder="请输入车队名称" :disabled="true"></el-input>
                </el-form-item>
                ...
                <el-form-item label="设备名称" prop="facilityName">
                    <el-input v-model="ruleFormEdit.facilityName" placeholder="请输入设备名称" :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="驾驶员姓名" prop="driverName">
                    <el-input v-model="ruleFormEdit.driverName" placeholder="请输入驾驶员姓名" :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="设备ID" prop="facilityId">
                    <el-input v-model="ruleFormEdit.facilityId" placeholder="请输入设备ID" :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="驾驶员电话" prop="driverPhone">
                    <el-input v-model="ruleFormEdit.driverPhone" placeholder="请输入驾驶员电话" :disabled="true"></el-input>
                </el-form-item>
...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            this.queryVehicleIsAudited({}).then(() => {
                _this.loading = false;
            });
